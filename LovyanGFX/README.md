...
```
3. The partition table or pin assignments is available in [arduino-esp32/variants/jczn_2432s028r/][4].
...
[^5]: It is connected to the pen output interrupt pin (`/PENIRQ` = `IO36`) in the [schematic][11]. Setting `CYD_TP_IRQ` is slightly more efficient.
...
[12]: https://github.com/lovyan03/LovyanGFX/blob/master/src/lgfx/v1/touch/Touch_XPT2046.cpp "LovyanGFX/src/lgfx/v1/touch/Touch_XPT2046.cpp at master · lovyan03/LovyanGFX"
