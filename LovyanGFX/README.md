...
| SPI Bus Settings | ILI9341 (micro-USB x 1 type) | ST7789 (micro-USB x 1 + USB-C x 1 type) | Description |
| ---------------- | ---------------------------- | --------------------------------------- | ----------- |
...
| Panel Control    | ILI9341 (micro-USB x 1 type) | ST7789 (micro-USB x 1 + USB-C x 1 type) | Description |
| ---------------- | ---------------------------- | --------------------------------------- | ----------- |
...
| Backlight Control | ILI9341 (micro-USB x 1 type) | ST7789 (micro-USB x 1 + USB-C x 1 type) | Description |
| ----------------- | ---------------------------- | --------------------------------------- | ----------- |
...
| Touch Control   | ILI9341 (micro-USB x 1 type) | ST7789 (micro-USB x 1 + USB-C x 1 type) | Description |
| --------------- | ---------------------------- | --------------------------------------- | ----------- |
