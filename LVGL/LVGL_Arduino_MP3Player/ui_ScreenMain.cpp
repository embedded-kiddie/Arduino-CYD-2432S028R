...
void ui_ScreenMain_screen_init(void) {
  ...
  /////////////////////// Arrow Icon ////////////////////////
  {
    ...
    static constexpr lv_style_const_prop_t style_prop_default_H[] = {
    ...
    static constexpr lv_style_const_prop_t style_prop_checked_H[] = {
      LV_STYLE_CONST_BG_IMAGE_SRC(&img_menu_up),
      LV_STYLE_CONST_BG_COLOR(UI_COLOR_BACKGROUND),
      LV_STYLE_CONST_PROPS_END
    };
    ...
    static LV_STYLE_CONST_INIT(style_default_H, (void*)style_prop_default_H);
    ...
    static LV_STYLE_CONST_INIT(style_checked_H, (void*)style_prop_checked_H);
