...
#define TFT_ROTATION  LV_DISPLAY_ROTATION_90 // LV_DISPLAY_ROTATION_{0|90|180|270}
...
//----------------------------------------------------------------------
#define ENABLE_SCREENSHOT false
...
void setup() {
  ...
  int n = ui_init();
  Serial.printf("Number of fonts: %d\n", n);
}
